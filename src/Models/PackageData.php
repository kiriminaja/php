...
class PackageData extends ModelBase
{
    ...
    public int $weight;                                           //	int(min:1)	false	Berat paket dalam gram
    public int $width;                                            //	int(min:1)	false	cm
    public int $length;                                           //	int(min:1)	false	cm
    public int $qty;                                              //	int	true	Jumlah barang dalam paket, akan terisi 1 jika kosong
    public int $height;                                           //	int(min:1)	false	cm
    public int $item_value;                                       //	int	false	Nilai barang secara keseluruhan
    public int $shipping_cost;                                    //	int	false	Biaya pengiriman, see # Shipping Price section
    ...
    public int $cod;                                              //	int	false	COD PRICE NB : Isi 0 untuk paket non COD
    public int $package_type_id;                                  //	int	false	Tipe paket tersedia untuk sementara 1
