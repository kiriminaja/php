...
class ProvinceServiceTest extends TestCase {
    ...
    private function setMock() {
        $mock = \Mockery::mock('overload:'.AddressRepository::class);
        $mock->shouldReceive('provinces')->andReturn($this->mockProvinces());
    }
    ...
    public function testProvinceServiceTest() {

        $service = (new ProvinceService)->call();

        echo "\nresult :".json_encode($service->toArray());
